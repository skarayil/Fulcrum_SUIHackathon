...
import { PersonIcon, ExclamationTriangleIcon, CheckCircledIcon, EyeOpenIcon, GearIcon, RocketIcon } from "@radix-ui/react-icons";
...
function LandingPageWrapper({ isLoading }: { role: string | null; isLoading: boolean }) {
  ...
  //   return <Navigate to="/contestant" replace />;
  // } else if (role === "jury") {
...
function AppContent() {
  ...
  const allNavItems = [
    ...
    { path: "/contestant", label: "Contestant", icon: PersonIcon, roles: ["contestant"] },
